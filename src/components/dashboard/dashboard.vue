<template>
  <div class='dashboard'>
    <el-row>
      <el-col :span="24"><h4>中央空调远程监控分布图</h4></el-col>
    </el-row>
    <el-row>
      <el-col :span="12"><div style="line-height: 40px; font-size: 14px;">空调总台数：1000台&nbsp;&nbsp;&nbsp;&nbsp;正常：900台&nbsp;&nbsp;&nbsp;&nbsp;故障报警：<span style="color: red">50</span>台&nbsp;&nbsp;&nbsp;&nbsp;断线：50台</div></el-col>
      <el-col :span="12" style="line-height: 40px; text-align: right">
