<template>
  <div class='station'>
        ...
        <el-form-item>
            ...
            :disabled="disabled">搜索</el-button>
          <el-button @click="closeTable()" :disabled="disabled" plain>重置</el-button>
          <el-button type="primary" @click="$router.push({path: '/station/addStation/0'})">新增空调站点</el-button>
        </el-form-item>
      </el-form>     
        <el-table
          v-loading="loading"
