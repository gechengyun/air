     ...
     <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm demo-form-inline" v-loading="loading">
      ...
      <el-row>
          ...
          <el-form-item label="归属项目" prop="projectId">
              <el-select v-model="ruleForm.projectId" placeholder="请选择归属项目" :disabled="this.$route.params.id!=undefined?true:false" @change="stationGetListBy(ruleForm.projectId)">
                <el-option
          ...
          <el-form-item label="归属空调站点" prop="airStationId" label-width="130px">
              <el-select v-model="ruleForm.airStationId" placeholder="请选择归属空调站点" :disabled="this.$route.params.id!=undefined?true:false" @change="equipmentlistselect(ruleForm.projectId,ruleForm.airStationId)">
              <el-option
      ...
      <el-row>
       <el-col :span="12">
          <el-form-item label="归属设备" prop="equipmentId">
...
<script>
import {getUserProjects,getObservationLocationDict,pointsGetOne,pointsAdd,pointsUpdate,equipmentlistselect,stationGetListBy,getUnitDict} from '../../config/api'
  export default {
    data() {
      return {
         project:[],
    ...
    created () {
      ...
      this.getSelectValue();
        ...
        this.views();
        this. stationGetListBy();
        this. equipmentlistselect()
      }else{
         this.loading=false;
      }
    ...
    methods: {
      ...
      equipmentlistselect(projectId,airStationId){
        ...
        stationGetListBy(projectId){
        this.ruleForm.airStationId='';
          this.ruleForm.equipmentId='';
         stationGetListBy({
          projectId:projectId
        }).then((resp)=>{
