        ...
        <el-table
          ...
          <el-table-column 
            ...
            <template slot-scope="scope">
              <el-tag :type="stateValue(scope.row.state).type"
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button
                ...
                type="text"
                @click="$router.push({
                  path: '/project/changeProject/' + scope.row.id,
                  query: {page: currentPage}
                })">项目信息</el-button>
              <el-button
                size="small"
...
export default {
  ...
  data () {
    return {
      form: {
        value: '全部',
        state: 0, // 选择状态 0-全部, 1-未开始, 2-进行中, 3-已过期
        name: '' // 项目名称
      },
      list: [
        // 状态栏
