...
/* 数据管理 */
export const dataGetMonitorPageList = (data = {}) => axios.post('/data/getMonitorPageList', data); // 获取站点信息列表
export const dataGetAirStationInfo = (data = {}) => axios.post('/data/getAirStationInfo', data); // 根据站点id获取站点信息
export const dataGetObservationInfo = (data = {}) => axios.post('/data/getObservationInfo', data); // 根据站点id获取站点信息
...
export const stationGetListBy = (data = {}) => axios.post('/airStation/getListBy', data); // 根据用户获取对应的站点信息
