     ...
     <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm demo-form-inline"  v-loading="loading">
      ...
      <el-row>
          ...
          <el-form-item label="归属空调站点" prop="airStationId" label-width="130px">
              <el-select v-model="ruleForm.airStationId" placeholder="请选择归属空调站点" :disabled="this.$route.params.id!=undefined?true:false">
                 <el-option
...
<script>
import {equipmentGetOne,getUserProjects,getEquipmentDict,equipmentAdd,equipmentUpdate,stationGetListBy} from '../../config/api'
  export default {
    data() {
      return {
        project:[],
